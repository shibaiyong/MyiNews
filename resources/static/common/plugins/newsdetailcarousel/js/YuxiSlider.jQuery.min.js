    ...
    a.fn.extend({
        YuxiSlider: function(b) {
            ...
            return a(this).each(function() {
                ...
                g = 0,
                h = null,
                i = '<div class="desc"><p class="title"><a href=""></a></p><span class="num"><em class="curr-num"></em><em class="line">/</em><em class="total-num"></em></span></div><div class="bg"><p class="title"><a href=""></a></p></div>';
                b.append(i);
                var j = a("p.title a", b),
                k = a("em.curr-num", b),
                l = a("em.total-num", b),
                ...
                p = {
                    ...
                    init: function() {
                        ...
                        b.add("li", b).width(d.width).height(d.height),
                        c.width(f * d.width),
                        p.description(),
                        p.bindControl(),
                    ...
                    description: function() {
                        k.text(g + 1),
                        l.text(f),
                        j.text(e.eq(g).find("img").attr("alt")).attr("href", e.eq(g).find("a").attr("href")).width('100%')
