...
$.extend( $.fn.dataTableExt.oPagination, {
    "bootstrap": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).append(
                '<ul class="pagination" style="margin-top:4px">'+
                '<div class="paginationSkip"><span>到第</span>'+
                '<input type="text" id="redirect" class="redirect" placeholder="1">'+
                '<span>页</span></div>'+
        ...
        "fnUpdate": function ( oSettings, fnDraw ) {
            ...
            for ( i=0, ien=an.length ; i<ien ; i++ ) {
                ...
                for ( j=iStart ; j<=iEnd ; j++ ) {
                    sClass = (j==oPaging.iPage+1) ? 'class="paginate_button active"' : 'class="paginate_button"';
