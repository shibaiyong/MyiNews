$(function(){
	...
	/*加载头部与尾部*/
    $('#header').loadPage('../common/header.html',2);
	...
	$(".titleRightClick>a").popover({
       ...
       // title:"标题",设置 弹出框 的标题
        ...
        content:"新京报快讯（记者卢通 实习生陈维城）今天上午11时，河北廊坊市开发区发生一起杀人案，一家五口在家中被害。新京报记者获取到的一份协查通报显示，2017年1月20日上午11时，廊坊市开发区发生一起杀人案，被害人刘某一家五口被杀死在家中。通报称，嫌疑人申某，男，35岁，原籍廊坊大城县，现户籍所在地为廊坊经济技术开发区友谊路。新京报快讯（记者卢通 实习生陈维城）今天上午11时，河北廊坊市开发区发生一起杀人案，一家五口在家中被害。新京报记者获取到的一份协查通报显示，2017年1月20日上午11时，廊坊市开发区发生一起杀人案，被害人刘某一家五口被杀死在家中。通报称，嫌疑人申某，男，35岁，原籍廊坊大城县，现户籍所在地为廊坊经济技术开发区友谊路。",//这里可以直接写字符串，也可以 是一个函数，该函数返回一个字符串；
        placement:'auto left',
	});
	/*$('.titleRightClick>a').on('shown.bs.popover', function () {
	  	popoverDotdotdot();
	})*/
...
/*悬停摘要省略*/
function popoverDotdotdot(){
	$('.popover-content').each(function(){
		if($('.popover-content').height()>=63){
			$(this).css({
				'height':63,
			});
			$(this).dotdotdot({
