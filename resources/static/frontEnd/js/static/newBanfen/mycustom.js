$(function(){
	...
	$('#screenSource').find('li').each(function(index){
		$(this).click(function(){
				$('.thread-recommend').removeClass('hide');
				$('.thread-custom').addClass('hide');
				$('.thread-mycustom').addClass('hide');
				$(this).addClass('active').siblings().removeClass('active');
				$('#mycustomSelf').find('li').removeClass('active');

		})
	})
	$('#mycustomSelf').find('li:eq(0)').click(function(){
		$('.thread-recommend').addClass('hide');
		$('.thread-custom').addClass('hide');
		$('.thread-mycustom').removeClass('hide');
		$(this).addClass('active').siblings().removeClass('active');
		$('#screenSource').find('li').removeClass('active');
	});
	$('#mycustomSelf').find('li:last-child').click(function(event) {
		$('.thread-recommend').addClass('hide');
		$('.thread-custom').removeClass('hide');
		$('.thread-mycustom').addClass('hide');
		$(this).addClass('active').siblings().removeClass('active');
		$('#screenSource').find('li').removeClass('active');
	});
