...
function getSlideData() {
    ...
    $.ajax({
        url : ctx+'/latest/front/getNewsDetail',//这个就是请求地址对应sAjaxSource http://127.0.0.1:8020/HelloHBuilder/test.json
        // url: 'http://127.0.0.1:8020/HelloHBuilder/test.json',//这个就是请求地址对应sAjaxSource
        data: {
...
//        		摘要
                ...
                if (obj.summary != null && obj.summary != '') {
                    $('#summaryContent').html('<p class="m-bottom"><strong>【机器摘要】</strong>' + obj.summary + '</p><a href="javascript:void(0)" style="font-size:14px;color:#ff6600;float:right" class="seeNewsDetail">[查看新闻详情]</a>')
...
//        		关键词
                var keyWords;
                keyWords = '<div class="customKeyWords">';
                if (obj.keyExpression != null && obj.keyExpression != '') {
                    var obj1 = obj.keyExpression;
                    for (var count = 0; obj1.length > count; count++) {
                        keyWords += '<span class="label label-orange-bg">' + obj1[count].expression + '</span>&nbsp;';
                    }
                    keyWords += '</div>'
                } else {
                    keyWords = ''
...
//            			将轮播图处的图片先设置为默认图片，从图片服务器返回回来的图片在替换
                        imgContent = '<img class="defaultImg" data-index="' + con + '" src="' + context + '/frontEnd/image/home/defaultImg.png"  data-widthHeight="' + imgObj[con].width + ' X ' + imgObj[con].height + '" />';
                        allPageImgCon = '<li class="span3 defaultImg" data-index="' + con + '"><a href="' + context + '/frontEnd/image/home/defaultImg.png"><img  src="' + context + '/frontEnd/image/home/defaultImg.png"/></a></li>'
...
//                        			allPageImgCon += '<li class="span3"><a href="'+data.value+'"><img  src="'+data.value+'"/></a></li>'
                        ...
                        cSlideUlCon = '<li ><img class="defaultImg" data-index="' + con + '" src="' + context + '/frontEnd/image/home/defaultImg.png"/><tt></tt></li>';
