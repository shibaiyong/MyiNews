...
//		    	相似相关、浏览量
                var relevantNewsNum = (data.relevantNewsNum != null && data.relevantNewsNum != '')? data.relevantNewsNum: 0;
                var sameNewsNum = (data.sameNewsNum != null && data.sameNewsNum != '')? data.sameNewsNum: 0;
                var relevantNum = '<span class="relevantNum">'+ relevantNewsNum+ '</span>';
                var sameNum = '<span class="sameNum">'+ sameNewsNum + '</span>';
...
//		    	   摘要
                ...
                content += '<em class="browseNum' + index + '"></em> <span>浏览量</span> <i>|</i> <em class="browseNum' + index + '"></em> <span>建稿量</span>';
